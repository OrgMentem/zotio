...
var fanoutRefusalReasons = map[string]fanoutRefusalReason{
	...
	"desktop status": {fanoutLibraryScoped,
		"it reports whether the Zotero desktop process runs, which has no library dimension"},
	"desktop wait": {fanoutFinite,
		"it blocks until Zotero desktop starts, and the desktop has no library dimension"},
