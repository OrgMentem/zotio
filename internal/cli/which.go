...
var whichIndex = []whichEntry{
	...
	{Command: "items enrich", Description: "Fill missing DOIs and abstracts, and attach open-access PDFs as links or downloaded files from CrossRef, OpenAlex, Semantic Scholar, and Unpaywall — preview-first, with provenance appended to each item.", Group: "Safe writes & import", WhyItMatters: "Turn the audit's missing-metadata queue into applied fixes; --validate cross-checks stored DOIs read-only."},
