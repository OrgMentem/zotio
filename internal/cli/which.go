...
var whichIndex = []whichEntry{
	...
	{Command: "items find", Description: "Resolve a DOI, ISBN, PMID, arXiv ID, citation key, URL, OpenAlex work ID, or exact title against the local mirror.", Group: "Safe writes & import", WhyItMatters: "Check whether a paper already exists before an import creates a duplicate."},
