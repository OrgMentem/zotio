...
but do not stop the import.`,
  ...
  zotero-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  zotero-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | zotero-pp-cli import <resource> --input -`,
