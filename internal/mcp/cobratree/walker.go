...
func RegisterAll(s *server.MCPServer, rootOrFactory any, cliPaths ...func() (string, error)) {
	var root *cobra.Command
	switch v := rootOrFactory.(type) {
	case nil:
		return
	case *cobra.Command:
		root = v
	...
	cliPath := SiblingCLIPath
	if len(cliPaths) > 0 && cliPaths[0] != nil {
		cliPath = cliPaths[0]
	}
